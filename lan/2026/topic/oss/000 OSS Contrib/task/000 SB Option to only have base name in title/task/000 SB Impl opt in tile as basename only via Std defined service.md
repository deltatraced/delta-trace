...
Spawned in: [[000 SB Option to only have base name in title#^spawn-task-287814|^spawn-task-287814]]
...
Latest changes in accordance with the diffs in [[004 SB How can we pass async determined data for the page title?]]
...
Spawn [[000 SB Services getting initialized multiple times and getting uninitialized between renders for page title]] ^spawn-issue-b202e7
...
Spawn [[005 SB How does viewDispatch work?]] ^spawn-invst-b898d2
...
Now we need to make sure these notes themselves are up to date to be included in the PR, right from the [[001 Overview SB Option to only have base name in title]].