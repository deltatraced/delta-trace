...
Spawned by: [[002 Issues during Can we have an external plug filter the title path for us?]]

Spawned in: [[002 Issues during Can we have an external plug filter the title path for us?#^spawn-invst-bd4095|^spawn-invst-bd4095]]
