...
I have a configured tmux setup that allows me to do prefix (C-a) + e, and if the tab is split between two panes, it switches to the other pane. but keeps it zoomed, so this way I can have two fully zoomed panes at all times in a tab.

The issue is immersion is broken so I am discouraged from using it: When I use the arrows to search for a command, it just breaks the zoom (prefix - z).
