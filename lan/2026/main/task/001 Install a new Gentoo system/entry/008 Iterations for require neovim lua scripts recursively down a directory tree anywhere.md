...
Spawned by: [[000 require neovim lua scripts recursively down a directory tree anywhere]]

Spawned in: [[000 require neovim lua scripts recursively down a directory tree anywhere#^spawn-entry-0edee3|^spawn-entry-0edee3]]
