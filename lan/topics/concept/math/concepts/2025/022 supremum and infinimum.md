...
This definition follows with Definition 2.2 from [Prof John Hunter m125b textbook chp2](https://www.math.ucdavis.edu/~hunter/m125b/ch2.pdf).
...
The supremum of a set $A$ is its least upper bound and is denoted $\sup A$.

The infinimum of a set $A$ is its greatest upper bound and is denotes $\inf A$

(3)

Let $A$ be a set $A = \{x_i : i \in I\}$ for some index $i$ in a set $I$.
