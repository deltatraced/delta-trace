...
It seems CTQS duplicates part of `/home/lan/.local/share/agda/2.8.0/lib/prim/Agda/Primitive.agda` to narrate why we need the declerations, so we should disable those duplications.
