...
From [[#^spawn-task-d3ebdf]] in [[#3.10 Reverse engineering the internal mini language]],
...
Spawn [[#3.5 Write python script to reconstruct tape until new undocumented command]] ^spawn-task-34592a
...
Spawn [[#6.2 Why is href being set in cmd22?]] ^spawn-invst-8f21a6
