...
Parent: [[000 Analysis I Terrance Tao Proofs]] ^22570d

Spawned by: [[000 Spawn Logs for Notes for Posts]]

Spawned in: [[000 Spawn Logs for Notes for Posts#^spawn-cncpt-5d5c76|^spawn-cncpt-5d5c76]]
...
4. To prevent other wrap-arounds and ceiling behavior, we provide a proof that succ is  [[012 injective|injective]]: ^ax4
...
To illustrate that this prevents wrap-back, see [[002 six_not_2|six-not-two]]. The same logic applies for ceiling, if `1 ≡ 2`, then `suc 0 ≡ suc 1` then `0 ≡ 1`
