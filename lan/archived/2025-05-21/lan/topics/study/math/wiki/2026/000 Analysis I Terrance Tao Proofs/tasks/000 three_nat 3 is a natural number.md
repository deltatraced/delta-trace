...
Spawned in: [[000 Spawn Logs for Notes for Posts#^spawn-task-461290|^spawn-task-461290]]
...
First, expand the definition of `3` as noted in [[000 Defn N#^notation1]]:
...
By utilizing [[000 Defn N#^ax1]], we can partially fill the hole `?0`. 

```haskell
three-nat .fst = {! ?2 0 0!}
```

By [[000 Defn N#^ax2]] We know there exists an element `suc 0`:
